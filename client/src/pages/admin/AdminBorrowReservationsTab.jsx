...
import { FaCheckCircle, FaTimesCircle, FaBookOpen, FaSync, FaInbox, FaThumbsUp, FaUndo, FaArchive, FaSearch } from 'react-icons/fa';
import api from '../../utils/api';
import { toast } from 'react-toastify';

const AdminBorrowReservationsTab = () => {
  ...
  const filterBorrows = () => {
    ...
    const resultList = filteredList.filter(b => {
      ...
      if (searchTerm.trim()) {
        ...
        const matchTitle = b.book?.title?.toLowerCase().includes(q);
  ...
  return (
    <div className="animate-fade-in-up">
      <div className="flex justify-between items-center mb-4">
        ...
        <button onClick={fetchBorrows} className="btn btn-outline" style={{ padding: '0.5rem 1rem', borderRadius: '24px' }}>
      ...
      <div style={{ display: 'flex', gap: '1rem', alignItems: 'center', flexWrap: 'wrap', padding: '1rem 0', marginBottom: '1.5rem' }}>
        <select 
          value={filterDay} 
...
export default AdminBorrowReservationsTab;
